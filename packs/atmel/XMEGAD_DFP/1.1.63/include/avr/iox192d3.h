...
#ifndef _AVR_ATXMEGA192D3_H_INCLUDED
#define _AVR_ATXMEGA192D3_H_INCLUDED
...
{
    register8_t RCOSC2M;  /* RCOSC 2MHz Calibration Value B */
    register8_t RCOSC2MA;  /* RCOSC 2MHz Calibration Value A */
    register8_t RCOSC32K;  /* RCOSC 32kHz Calibration Value */
    register8_t RCOSC32M;  /* RCOSC 32MHz Calibration Value B */
    register8_t RCOSC32MA;  /* RCOSC 32MHz Calibration Value A */
    register8_t reserved_0x05;
    register8_t reserved_0x06;
    register8_t reserved_0x07;
...
{
    NVM_FUSES_BODPD_INSAMPLEDMODE_gc = (0x01<<0),  /* BOD enabled in sampled mode */
    NVM_FUSES_BODPD_CONTINOUSLY_gc = (0x02<<0),  /* BOD enabled continuously */
    NVM_FUSES_BODPD_DISABLED_gc = (0x03<<0),  /* BOD Disabled */
} NVM_FUSES_BODPD_t;
...
{
    NVM_FUSES_TOSCSEL_ALTERNATE_gc = (0x00<<5),  /* TOSC1/2 on separate pins */
    NVM_FUSES_TOSCSEL_XTAL_gc = (0x01<<5),  /* TOSC1/2 shared with XTAL */
} NVM_FUSES_TOSCSEL_t;

/* Watchdog (Window) Timeout Period */
typedef enum NVM_FUSES_WDP_enum
{
    NVM_FUSES_WDP_8CLK_gc = (0x00<<0),  /* 8 cycles (8ms @ 3.3V) */
    NVM_FUSES_WDP_16CLK_gc = (0x01<<0),  /* 16 cycles (16ms @ 3.3V) */
    NVM_FUSES_WDP_32CLK_gc = (0x02<<0),  /* 32 cycles (32ms @ 3.3V) */
    NVM_FUSES_WDP_64CLK_gc = (0x03<<0),  /* 64 cycles (64ms @ 3.3V) */
    NVM_FUSES_WDP_128CLK_gc = (0x04<<0),  /* 128 cycles (0.125s @ 3.3V) */
    NVM_FUSES_WDP_256CLK_gc = (0x05<<0),  /* 256 cycles (0.25s @ 3.3V) */
    NVM_FUSES_WDP_512CLK_gc = (0x06<<0),  /* 512 cycles (0.5s @ 3.3V) */
    NVM_FUSES_WDP_1KCLK_gc = (0x07<<0),  /* 1K cycles (1s @ 3.3V) */
    NVM_FUSES_WDP_2KCLK_gc = (0x08<<0),  /* 2K cycles (2s @ 3.3V) */
    NVM_FUSES_WDP_4KCLK_gc = (0x09<<0),  /* 4K cycles (4s @ 3.3V) */
    NVM_FUSES_WDP_8KCLK_gc = (0x0A<<0),  /* 8K cycles (8s @ 3.3V) */
} NVM_FUSES_WDP_t;
...
{
    TC_AWEX_FDACT_NONE_gc = (0x00<<0),  /* No Fault Protection */
    TC_AWEX_FDACT_CLEAROE_gc = (0x01<<0),  /* Clear Output Enable Bits */
    TC_AWEX_FDACT_CLEARDIR_gc = (0x03<<0),  /* Clear I/O Port Direction Bits */
} TC_AWEX_FDACT_t;

/* High Resolution Enable */
typedef enum TC_HIRES_HREN_enum
{
    TC_HIRES_HREN_NONE_gc = (0x00<<0),  /* No Fault Protection */
    TC_HIRES_HREN_TC0_gc = (0x01<<0),  /* Enable High Resolution on Timer/Counter 0 */
    TC_HIRES_HREN_TC1_gc = (0x02<<0),  /* Enable High Resolution on Timer/Counter 1 */
    TC_HIRES_HREN_BOTH_gc = (0x03<<0),  /* Enable High Resolution both Timer/Counters */
} TC_HIRES_HREN_t;
...
#define ADC_CH_SCANNUM_gm  0x0F  /* Number of Channels included in scan(Legacy name) group mask. */
#define ADC_CH_SCANNUM_gp  0  /* Number of Channels included in scan(Legacy name) group position. */
#define ADC_CH_SCANNUM0_bm  (1<<0)  /* Number of Channels included in scan(Legacy name) bit 0 mask. */
#define ADC_CH_SCANNUM0_bp  0  /* Number of Channels included in scan(Legacy name) bit 0 position. */
#define ADC_CH_SCANNUM1_bm  (1<<1)  /* Number of Channels included in scan(Legacy name) bit 1 mask. */
#define ADC_CH_SCANNUM1_bp  1  /* Number of Channels included in scan(Legacy name) bit 1 position. */
#define ADC_CH_SCANNUM2_bm  (1<<2)  /* Number of Channels included in scan(Legacy name) bit 2 mask. */
#define ADC_CH_SCANNUM2_bp  2  /* Number of Channels included in scan(Legacy name) bit 2 position. */
#define ADC_CH_SCANNUM3_bm  (1<<3)  /* Number of Channels included in scan(Legacy name) bit 3 mask. */
#define ADC_CH_SCANNUM3_bp  3  /* Number of Channels included in scan(Legacy name) bit 3 position. */
...
#endif /* #ifdef _AVR_ATXMEGA192D3_H_INCLUDED */
