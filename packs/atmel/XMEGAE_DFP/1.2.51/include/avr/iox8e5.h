...
typedef enum TC_CCAMODE_enum
{
    ...
    TC_CCAMODE_COMP_gc = (0x01<<0),  /* Ouput Compare enabled */
...
typedef enum TC_CCBMODE_enum
{
    ...
    TC_CCBMODE_COMP_gc = (0x01<<2),  /* Ouput Compare enabled */
...
typedef enum TC_CCCMODE_enum
{
    ...
    TC_CCCMODE_COMP_gc = (0x01<<4),  /* Ouput Compare enabled */
...
typedef enum TC_CCDMODE_enum
{
    ...
    TC_CCDMODE_COMP_gc = (0x01<<6),  /* Ouput Compare enabled */
...
typedef enum TC_HCCAMODE_enum
{
    ...
    TC_HCCAMODE_COMP_gc = (0x01<<0),  /* Ouput Compare enabled */
...
typedef enum TC_HCCBMODE_enum
{
    ...
    TC_HCCBMODE_COMP_gc = (0x01<<2),  /* Ouput Compare enabled */
...
typedef enum TC_HCCCMODE_enum
{
    ...
    TC_HCCCMODE_COMP_gc = (0x01<<4),  /* Ouput Compare enabled */
...
typedef enum TC_HCCDMODE_enum
{
    ...
    TC_HCCDMODE_COMP_gc = (0x01<<6),  /* Ouput Compare enabled */
...
typedef enum TC_LCCAMODE_enum
{
    ...
    TC_LCCAMODE_COMP_gc = (0x01<<0),  /* Ouput Compare enabled */
...
typedef enum TC_LCCBMODE_enum
{
    ...
    TC_LCCBMODE_COMP_gc = (0x01<<2),  /* Ouput Compare enabled */
...
typedef enum TC_LCCCMODE_enum
{
    ...
    TC_LCCCMODE_COMP_gc = (0x01<<4),  /* Ouput Compare enabled */
...
typedef enum TC_LCCDMODE_enum
{
    ...
    TC_LCCDMODE_COMP_gc = (0x01<<6),  /* Ouput Compare enabled */
